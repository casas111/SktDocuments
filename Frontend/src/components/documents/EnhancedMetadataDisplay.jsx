...
/**
 * Enhanced Document Metadata Component
 * 
              ...
              <Grid item xs={12} sm={6}>
                ...
                {!metadata.isDirectory && (
                  <MetadataItem>
                    ...
                    <MetadataValue variant="body2">{formatFileSize(metadata.size)}</MetadataValue>
                  </MetadataItem>
                )}
            ...
            <List>
              {metadata.contents.map((item, index) => (
                <ListItem key={index}>
                  ...
                  <ListItemText
                    primary={item.name}
                    secondary={item.isDirectory ? 'Folder' : formatFileSize(item.size)}
                  />
                </ListItem>
              ))}
            </List>
